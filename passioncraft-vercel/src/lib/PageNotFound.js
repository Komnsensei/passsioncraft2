            ...
            <div className="max-w-md w-full">
                <div className="text-center space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="h-0.5 w-16 mx-auto" style={{ background: 'var(--border-dim)' }}></div>
                    </div>
                    ...
                    <div className="space-y-3">
                        ...
                        <p className="leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
                            The page <span className="font-medium" style={{ color: 'var(--text-primary)' }}>"{pageName}"</span> could not be found in this application.
                        </p>
                    </div>
